...
self.addEventListener('push', e => {
    ...
    const options = {
        ...
        image: 'http://es.web.img3.acsta.net/r_640_360/newsv7/17/07/30/13/53/005215.jpg',
...
self.addEventListener('notificationclick', e => {
    ...
    // Abrir el navegador si esta cerrado, en caso de estar
    // abierto con una pestaña de la aplicación, entonces se
    // utiliza esa pestaña
